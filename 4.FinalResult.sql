...
--Verifying if the increase of the average emission of CO2 affects the average life expectancy between 2000 and 2017 in Countries
...
-- Verify if the level of the emission of CO2 affects the life expectancy for top 8 most industrialised country in 2017
...
-- Verifying if Country produced enough amount of Coal in comparison to consumption between 2000 and 2019
...
-- The Summary of  Coal Production & Consumption  and Emission of CO2 and Life Expectancy in 2017
SELECT E.Entity as Country, E.Year,
	CAST((e.Annual_CO2_Tonnes/1000000) as DECIMAL(32,2)) as [Annual Emission CO2 (MT)], 
	LE.Life_expectancy as [Life Expectancy],
...
--Comparison between SUM of Coal Consumption & Production with CO2 Emission  between 2000 and 2019 by Country
...
--Comparison between the average of Coal Consumption & Production with CO2 Emission  between 2000 and 2019 by Country
